...
var_dump(filter_var($var,FILTER_VALIDATE_URL,FILTER_FLAG_PATH_REQUIRED)); // FILTER_NULL_ON_FAILURE is return null because this option/flag use in this statement
