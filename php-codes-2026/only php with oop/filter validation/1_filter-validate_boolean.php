...
var_dump(filter_var($var,FILTER_VALIDATE_BOOLEAN,FILTER_NULL_ON_FAILURE)); // FILTER_NULL_ON_FAILURE is return null because this option/flag use in this statement
