<?php
$var = "https://vinay.com/leptop?A=2&b=2";
...
var_dump(filter_var($var,FILTER_VALIDATE_URL,FILTER_FLAG_QUERY_REQUIRED)); // FILTER_NULL_ON_FAILURE is return null because this option/flag use in this statement
